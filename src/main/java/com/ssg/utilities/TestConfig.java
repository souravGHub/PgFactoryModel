package com.ssg.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "sourav2u06@gmail.com";
	public static String password = "5tgb%TGB";
	public static String[] to ={"sourav2u02@yahoo.com"};
